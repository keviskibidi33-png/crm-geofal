...
const ControlAmbientalModule = dashboardDynamic(async () => (await import("@/components/dashboard/control-ambiental-module")).ControlAmbientalModule)
...
const HuantaProbetasModule = dashboardDynamic(async () => (await import("@/components/dashboard/huanta-probetas-module")).HuantaProbetasModule)
const HuantaCompresionModule = dashboardDynamic(async () => (await import("@/components/dashboard/huanta-compresion-module")).HuantaCompresionModule)
const HuantaSeguimientoModule = dashboardDynamic(async () => (await import("@/components/dashboard/huanta-seguimiento-module")).HuantaSeguimientoModule)
  ...
  const renderModule = () => {
    ...
    switch (activeModule) {
      ...
      case "control_ambiental":
        return (
          <RoleGuard user={dashboardUser} allowedRoles={["admin", "jefe_laboratorio", "oficina_tecnica"]} allowedEmails={["tecnico3@geofal.com.pe", "sig@geofal.com.pe", "beatriz", "oficinatecnica1", "oficinatecnica"]}>
            <ControlAmbientalModule key="control_ambiental_temperatura" user={dashboardUser} defaultTab="temperatura" />
          </RoleGuard>
        )
      case "control_ambiental_balanzas":
        return (
          <RoleGuard user={dashboardUser} allowedRoles={["admin", "jefe_laboratorio", "oficina_tecnica"]} allowedEmails={["tecnico3@geofal.com.pe", "sig@geofal.com.pe", "beatriz", "oficinatecnica1", "oficinatecnica"]}>
            <ControlAmbientalModule key="control_ambiental_balanzas" user={dashboardUser} defaultTab="balanza" />
          </RoleGuard>
        )
      ...
      case "huanta_probetas":
        return <HuantaProbetasModule />
      case "huanta_compresion":
        return <HuantaCompresionModule />
      case "huanta_seguimiento":
        return <HuantaSeguimientoModule />
      case "humedad":
