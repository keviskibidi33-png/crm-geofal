export const PERMISSION_MODULE_CATALOG = [
  ...
  { id: "ot_concreto", label: "Orden de Trabajo (OT) - Concreto" },
  { id: "recepcion", label: "Recepción Probetas (Concreto)" },
  { id: "recepcion_lima", label: "Recepción Muestras (Lab. Lima)" },
  ...
  { id: "huanta_probetas", label: "Control Probetas Huanta" },
  { id: "huanta_compresion", label: "Compresión Huanta" },
  { id: "huanta_seguimiento", label: "Seguimiento Huanta" },
  ...
  { id: "estadistica_gerencia", label: "KPIs Administración — En desarrollo" },
