...
const modules: { id: ModuleType; label: string; icon: React.ElementType; adminOnly?: boolean }[] = [
  ...
  { id: "abrass", label: "ABRASS", icon: Beaker, adminOnly: true },
  ...
  { id: "cd", label: "CD", icon: Beaker, adminOnly: true },
  { id: "ph", label: "PH", icon: Beaker, adminOnly: true },
  { id: "cloro_soluble", label: "Cloro Soluble", icon: Beaker, adminOnly: true },
  { id: "sales_solubles", label: "Sales Solubles", icon: Beaker, adminOnly: true },
  { id: "sulfatos_solubles", label: "Sulfatos Solubles", icon: Beaker, adminOnly: true },
  { id: "compresion_no_confinada", label: "Compresion No Confinada", icon: Beaker, adminOnly: true },
