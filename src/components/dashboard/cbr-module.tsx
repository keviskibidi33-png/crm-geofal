...
import { Plus, Gauge, Loader2, AlertCircle, RefreshCw, Search, Eye, Pencil, Trash2, X, Download } from "lucide-react"
...
import CBRForm from "./cbr-native/CBRForm"
...
interface CBREnsayoDetail extends CBREnsayoSummary {
    payload?: {
...
export function CBRModule() {
    const [isModalOpen, setIsModalOpen] = useState(false)
    const [isDetailOpen, setIsDetailOpen] = useState(false)
    const [token, setToken] = useState<string | null>(null)
    const [ensayos, setEnsayos] = useState<CBREnsayoSummary[]>([])
    ...
    const FRONTEND_URL = (
        ...
        process.env.NEXT_PUBLIC_CBR_URL ||
    ...
    const openDetail = async (id: number) => {
        ...
        try {
            ...
            const data: CBREnsayoDetail = await res.json()
    ...
    const handleDownloadRow = async (id: number, muestraCodigo?: string | null) => {
        ...
        try {
            const url = `${API_URL}/api/cbr/excel?download=true&ensayo_id=${id}`
            ...
            let filename = `CBR_${muestraCodigo || id}.xlsx`
    ...
    const handleDeleteEnsayo = useCallback(async () => {
        ...
        try {
            ...
            toast.success("Ensayo CBR enviado a papelera.")
        ...
        <div className="space-y-4 lg:space-y-6">
            ...
            <div className="border rounded-xl shadow-sm bg-white">
                <div className="px-4 py-3 border-b bg-slate-50/70 rounded-t-xl">
                    <h3 className="text-sm font-semibold text-slate-900">Historial de CBR</h3>
                ...
                <Table className="min-w-[860px]">
                    ...
                    <TableCaption className="text-xs text-muted-foreground">CBR — listado con búsqueda y acceso rápido.</TableCaption>
                </Table>
            </div>
            ...
            <Dialog open={isDetailOpen} onOpenChange={setIsDetailOpen}>
                <DialogContent className="max-w-xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>Información guardada del Ensayo CBR.</DialogDescription>
                    </DialogHeader>
                    {selectedDetail ? (
                        <div className="space-y-2 text-sm">
                            ...
                            <p><span className="font-semibold">Descripcion ASTM D2488:</span> {selectedDetail.payload?.descripcion_muestra_astm || "-"}</p>
