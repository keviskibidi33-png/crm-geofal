...
import { Plus, FlaskConical, Loader2, AlertCircle, RefreshCw, Search, Eye, Pencil, Trash2, Download } from "lucide-react"
...
export function AbrassModule() {
  ...
  const handleDownloadRow = async (id: number, muestraCodigo?: string | null) => {
    ...
    try {
      const url = `${API_URL}/api/abrass/excel?download=true&ensayo_id=${id}`
      ...
      let filename = `ABRASS_${muestraCodigo || id}.xlsx`
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      ...
      <ModernConfirmDialog
        ...
        title="Eliminar Ensayo de Abrasión"
