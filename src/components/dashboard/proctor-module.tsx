...
import { Plus, Gauge, Loader2, AlertCircle, RefreshCw, Search, Eye, Pencil, Trash2, Download, X, FlaskConical } from "lucide-react"
...
export function ProctorModule() {
    ...
    const handleDownloadRow = async (id: number, muestraCodigo?: string | null) => {
        ...
        try {
            const url = `${API_URL}/api/proctor/excel?download=true&ensayo_id=${id}`
            ...
            let filename = `PROCTOR_${muestraCodigo || id}.xlsx`
