        ...
        async (download: boolean) => {
            ...
            try {
                ...
                if (download) {
                    ...
                    toast.success('Sales solubles guardado y descargado.')
                } else {
                    ...
                    toast.success('Sales solubles guardado. Puedes seguir editando.')
                }
            } catch (err) {
                ...
                <div className="flex items-center justify-between gap-3 rounded-2xl border border-slate-200/80 bg-white/95 backdrop-blur-md px-5 py-4 shadow-xs">
                    <div className="flex items-center gap-3.5">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 font-medium">Formato Oficial F-LEM-P-SU-06.01</p>
                            {ensayoId && (
