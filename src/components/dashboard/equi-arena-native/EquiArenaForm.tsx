                ...
                <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="h-11 rounded-lg border border-slate-900 bg-white text-slate-900 font-semibold shadow-sm transition hover:bg-slate-100 disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="h-11 rounded-lg border border-emerald-700 bg-emerald-700 text-white font-semibold shadow-sm transition hover:bg-emerald-800 disabled:opacity-50 flex items-center justify-center gap-2"
                        >
