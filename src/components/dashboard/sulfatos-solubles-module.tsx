...
export function SulfatosSolublesModule() {
  ...
  const handleDeleteEnsayo = useCallback(
    async (id: number) => {
      ...
      if (!window.confirm(`Enviar a papelera el ensayo de Sulfatos Solubles ${ensayoLabel}? Se puede recuperar luego.`)) return
    ...
    <div className="space-y-4 lg:space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-xl sm:text-2xl font-bold tracking-tight leading-tight break-words">ENSAYO Sulfatos Solubles</h2>
      ...
      <div className="border rounded-xl shadow-sm bg-white">
        <div className="px-4 py-3 border-b bg-slate-50/70 rounded-t-xl">
          <h3 className="text-sm font-semibold text-slate-900">Historial Sulfatos Solubles</h3>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-[95vw] w-full h-[95vh] p-0 overflow-hidden bg-background [&>button]:hidden">
          <DialogHeader className="hidden">
            <DialogTitle>Ensayo Sulfatos Solubles</DialogTitle>
            <DialogDescription>Formulario Sulfatos Solubles</DialogDescription>
          </DialogHeader>
          <SmartIframe src={iframeSrc} title="Sulfatos Solubles CRM" />
        </DialogContent>
      </Dialog>
