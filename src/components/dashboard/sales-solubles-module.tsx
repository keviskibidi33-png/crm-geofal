...
export function SalesSolublesModule() {
  ...
  const handleDeleteEnsayo = useCallback(
    async (id: number) => {
      ...
      if (!window.confirm(`Enviar a papelera el ensayo de Sales Solubles ${ensayoLabel}? Se puede recuperar luego.`)) return
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-[95vw] w-full h-[95vh] p-0 overflow-hidden bg-background [&>button]:hidden">
          <DialogHeader className="hidden">
            <DialogTitle>Ensayo Sales Solubles</DialogTitle>
            <DialogDescription>Formulario Sales Solubles</DialogDescription>
          </DialogHeader>
