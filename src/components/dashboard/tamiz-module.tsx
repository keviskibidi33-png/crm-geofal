...
import { Plus, Scale, Loader2, RefreshCw, Search, Eye, Pencil, Trash2, Download, FlaskConical } from "lucide-react"
...
export function TamizModule() {
  ...
  const handleDownloadRow = async (id: number, muestraCodigo?: string | null) => {
    ...
    try {
      const url = `${API_URL}/api/tamiz/excel?download=true&ensayo_id=${id}`
      ...
      let filename = `TAMIZ_${muestraCodigo || id}.xlsx`
