...
export function CloroSolubleModule() {
  ...
  const handleDeleteEnsayo = useCallback(
    async (id: number) => {
      ...
      if (!window.confirm(`Enviar a papelera el ensayo de Cloro Soluble ${ensayoLabel}? Se puede recuperar luego.`)) return
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-[95vw] w-full h-[95vh] p-0 overflow-hidden bg-background [&>button]:hidden">
          <DialogHeader className="hidden">
            <DialogTitle>Ensayo Cloro Soluble</DialogTitle>
            <DialogDescription>Formulario Cloro Soluble</DialogDescription>
          </DialogHeader>
